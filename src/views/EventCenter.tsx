...
import { AlertCircle, ShieldAlert, CheckCircle2, Clock, Check, Loader2, Search, Filter, Activity, Zap, Server } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-6 h-full">
            ...
            <div className="event-dashboard-grid mb-2">
                ...
                <div className="dashboard-card glass-panel relative overflow-hidden">
            ...
            <div className="events-grid">
                ...
                <div className="glass-panel p-5 flex flex-col gap-4">
                    <div className="flex justify-between items-center mb-4 flex-wrap gap-4">
                        ...
                        <div className="flex gap-4 flex-wrap">
                            <div className="filter-buttons">
                                <button className={`filter-btn ${activeFilter === 'All' ? 'active' : ''}`} onClick={() => setActiveFilter('All')}>All Filters</button>
                    ...
                    <h3 className="text-lg font-bold text-white mt-6 border-b border-color-border pb-2 mb-2">Recently Resolved</h3>
